...
export default function ChatView({ threadId }: ChatViewProps) {
  ...
  const _customModelsForSelectedProvider = getCustomModelsForProvider(settings, selectedProvider);
  ...
  const _isComposerApprovalState = activePendingApproval !== null;
...
const _UNAVAILABLE_PROVIDER_OPTIONS = PROVIDER_OPTIONS.filter((option) => !option.available);
